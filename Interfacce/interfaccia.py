...
# apriamo il file in lettura
    ...
    picture = Picture(app, image="plot.png")

app= App(title="Grafico")
etichetta=Text(app,text="scegli file dati.txt")
percorso= TextBox(app)
pushGrafico= PushButton(app, text="Genera!", command=Grafico, args=[percorso])
app.display()
